 ...
 */
class m200518_112153_create_place_lang_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
         ...
         $this->addForeignKey('fk_place_lang_place_id','place_lang','place_id','place','id');
    }
    ...
    {
        $this->dropForeignKey('fk_place_lang_place_id','place_lang');
